...
cleanup() {
  local base="/bloom/petals/hyperliquid/wallets/${BLOOM_EVAL_WALLET_ID}/0/mainnet/agent_sessions/${BLOOM_EVAL_SESSION_ID}"
  local open_orders="/bloom/petals/hyperliquid/wallets/${BLOOM_EVAL_WALLET_ID}/0/mainnet/users/${BLOOM_EVAL_WALLET}/open_orders.json"
