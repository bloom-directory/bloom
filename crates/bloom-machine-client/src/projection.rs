...
mod tests {
    ...
    fn migration_result(operation_id: OperationId, fixture: &ProjectionFixture) -> CustodyResult {
        CustodyResult {
            ...
            // This branch makes the wallet root key ref optional, so a fixture with
            // no root key contributes no public key ref rather than panicking.
            public_key_refs: fixture.wallet.root_key_ref.clone().into_iter().collect(),
